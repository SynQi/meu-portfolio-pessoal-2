  ...
  return (
    ...
    >
      <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-4">
        Olá, eu sou <span className="text-blue-600 dark:text-blue-400">William Nunes
        </span>
      </h1>
      <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 mb-8 max-w-2xl">
        Desenvolvedor e fascinado em segurança da informação, dedicado ao estudo e aprimoramento de minhas habilidades com Linux, Redes e Scripting.
      </p>
      <motion.button 
